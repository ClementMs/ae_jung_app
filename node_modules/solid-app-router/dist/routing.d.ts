...
import type { Branch, Location, LocationChangeSignal, Params, Route, RouteContext, RouteDataFunc, RouteDefinition, RouteMatch, RouterContext, RouterIntegration } from "./types";
...
export declare const useResolvedPath: (path: () => string) => import("solid-js").Accessor<string | undefined>;
export declare const useHref: (to: () => string | undefined) => import("solid-js").Accessor<string | undefined>;
export declare const useNavigate: () => import("./types").Navigator;
export declare const useLocation: () => Location<import("./types").LocationState>;
export declare const useIsRouting: () => () => boolean;
export declare const useMatch: (path: () => string) => import("solid-js").Accessor<import("./types").PathMatch | null>;
export declare const useParams: <T extends Params>() => T;
export declare const useData: <T>(delta?: number) => T;
...
export declare function createLocation(path: () => string): Location;
