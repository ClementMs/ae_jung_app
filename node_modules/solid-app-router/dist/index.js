import { isServer, template, createComponent as createComponent$1, mergeProps, delegateEvents, spread, insert, effect, setAttribute } from 'solid-js/web';
import { createSignal, onCleanup, runWithOwner, createMemo, getOwner, createContext, useContext, createComponent, useTransition, on, untrack, createRenderEffect, createRoot, Show, mergeProps as mergeProps$1, splitProps } from 'solid-js';
...
function pathIntegration() {
  return createIntegration(() => window.location.pathname + window.location.search, ({
    value,
    replace
  }) => {
    if (replace) {
