...
export declare type LocationState = string | null;
export declare type RouteData = Record<string, any>;
...
export declare type NavigatorFactory = () => Navigator;
...
export declare type RouteDataFunc = (args: {
    params: Params;
    location: Location;
    navigate: Navigator;
}) => RouteData | undefined;
