...
export declare function toArray<T>(items: T | T[]): T[];
export declare function joinPaths(from: string, to: string): string;
export declare function extractQuery(url: URL): Params;
...
export declare function createMemoObject<T extends object>(fn: () => T): T;
